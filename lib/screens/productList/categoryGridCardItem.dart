...
class _CategoryCardItemState extends State<CategoryCardGrid> {
            ...
            child: Stack(
              children: [
                Container(
                  ...
                  height: sizeSettings.fullWidth / 6,
                ...
                children: [
                  if (widget.productModel.stock! > 0) ...{
                    if (cartController.productsCodeList
                        .contains(widget.productModel.productCode)) ...{
                      addRemoveButton(widget.productModel.productCode!, context)
                    } else
                      SizedBox(
                        height: 32,
    ...
    return Positioned(
      ...
      child: Container(
        ...
        child: Text(
          "15 % Off",
          style: TextStyle(
              fontWeight: FontWeight.bold, color: kBackgroudColor, fontSize: 9),
        ),
      ),
    );
  }
  ...
  Container itemLeftInStock() {
    return Container(
      ...
      child: Text(
        ...
        style: TextStyle(
            fontWeight: FontWeight.w600, color: kPrimaryRed, fontSize: 8),
      ),
    );
  }
}
