...
import 'categoryGridCardItem.dart';
            ...
            child: Container(
              ...
              child: SingleChildScrollView(
                child: ListView.builder(
                  shrinkWrap: true,
                  controller: homeController.listScrollcontroller,
                  itemCount: homeController.categories.length,
                  itemBuilder: (context, index) => GestureDetector(
                    onTap: () {
                      homeController.fetchCategoryProducts(
                          homeController.categories[index].catId);
                      brandController
                          .selectCategory(homeController.categories[index]);
                    },
                    child: Container(
                      child: Column(
                        children: [
                          ...
                          Container(
                            width: 75,
                            child: Text(
                              homeController.categories[index].catName,
                              style: TextStyle(
                                fontSize: 12,
                                fontWeight: FontWeight.bold,
                              ),
              ...
              () => (homeController.loading.value)
                  ...
                  : Container(
                      ...
                      child: GridView.builder(
                        controller: homeController.listScrollcontroller,
                        itemCount: homeController.catProductsList.length,
                        itemBuilder: (context, index) => CategoryCardGrid(
                          productModel: homeController.catProductsList[index],
                        ),
